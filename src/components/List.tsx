...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Select, MenuItem, TablePagination, Box, IconButton, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle } from '@mui/material';
                        ...
                        <TableBody>
                            {slicedIds.map((id, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>
                                        {(id !== null) && (
                                            <IconButton onClick={() => handleDeleteId(id)} sx={{ ml: 1 }}>
                                                <Delete color='error' />
                                            </IconButton>
                                        )}
                                    </TableCell>
